"""
Django settings for djangosendgrid project.
...
ROOT_URLCONF = 'djangosendgrid.urls'
...
WSGI_APPLICATION = 'djangosendgrid.wsgi.application'
...
# SENDGRID_EMAIL_USERNAME ='django_sendgrid'
POST_OFFICE = {
    'BACKENDS': {
